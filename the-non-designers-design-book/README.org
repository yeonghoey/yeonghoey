...
| Use typographer quote marks | No typewriter quotation marks    | ~'No', "No", ‘Yes’, “Yes”~                           |
| Apostrophes                 | 〃                               | ~It’s~, not ~It’s~; ~Rock’n’Rool~, not ~Rock‘n’Roll~ |
| Hyphen                      | hyphenating words or line breaks | ~odd-looking critters~, ~Merriam-Webster Dictionary~ |
