...
* Type
| One space after punctuation       | The two spaces is old-style                               | =Put one space._After punctuation.= |
| Use typographer quote marks       | No typewriter quotation marks                             | ='=, ="=, (6 and 9 shapes)          |
| Apostrophes                       | 〃                                                        | 〃                                  |
| Hyphen                            | hyphenating words or line breaks(or phone numbers)        | =ex-wife=~, =red-haired cousin=     |
...
| Punctuation following styled text | should be in the same style                               | =*Yes.*=, not =*No*.=               |
| Punctuation in or out parentheses | Outside if content is a part of sentence inside otherwise | =Blah(something).= =Blah(Blah.)=    |
