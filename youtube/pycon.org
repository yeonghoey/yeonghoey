...
* Table of Contents :TOC_2_gh:
 - [[#pycon-2017-modern-python-dictionaries-a-confluence-of-a-dozen-great-ideas---raymond-hettinger][PyCon 2017 Modern Python Dictionaries A confluence of a dozen great ideas - Raymond Hettinger]]
   ...
   - [[#faster-matching][Faster Matching]]
   - [[#open-addressing][Open Addressing]]
   - [[#deleted-entries][Deleted Entries]]
   - [[#multiple-hashing][Multiple Hashing]]
   - [[#early-out-for-lookups][Early-Out For Lookups]]
   - [[#compact-dict][Compact Dict]]
   - [[#key-sharing-dictionary][Key Sharing Dictionary]]
